 ...
 *  requireRole("platform_superadmin") and AdminShell's `isSuper` already admit. Any lower admin sees a clear
...
const OWNER_ROLES = new Set(['platform_superadmin']);
    ...
    return (
      <div className="flex flex-col items-center gap-2 rounded-2xl border border-dashed border-warn/50 bg-warn/5 p-8 text-center">
        ...
        <p className="max-w-md text-sm text-muted">
          This is a system-governance setting reserved for the system owner. Operators don&apos;t have access —
