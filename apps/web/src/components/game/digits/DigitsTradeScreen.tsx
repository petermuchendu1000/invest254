...
import { payoutForStake } from '@/lib/game/digitPayout';
...
export function DigitsTradeScreen() {
  ...
  // Stake is the SINGLE source of truth for place()/onCta/AUTO. The console is stake-entry only;
  // each outcome CTA already surfaces its own potential payout, so there is no separate payout input.
    ...
    <div className="flex h-full min-h-0 flex-col gap-1.5 overflow-y-auto overflow-x-hidden overscroll-contain p-0.5 pb-2 sm:gap-2 lg:flex-row lg:gap-3 lg:overflow-hidden lg:p-1">
      ...
      <div className="flex min-h-0 flex-col gap-1.5">
        ...
        <div className="flex rounded-xl border border-border bg-surface p-1">
            ...
            {/* Stake stepper — the single amount input (each CTA shows its own potential payout) */}
