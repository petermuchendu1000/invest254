...
## 3. Capability matrix (the single source of truth — to be implemented as `packages/shared/src/capabilities.ts`)
...
| Console: performance & live feed | ✅ | ✅ (P) | — |
...
· 8. UI-2 owner back-office model (**decision**) · 9. UI-9 / UI-10 gaps · 10. UI-12 / UI-14 (**decisions**).
